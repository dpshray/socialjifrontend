...
import GigsUpdateForm from "@/components/form/gig-from/GigsUpdateForm";
                ...
                const formattedGigData = {
                    ...
                    pricing: Array.isArray(data?.pricings)
                        ? data.pricings.map((pricing: any) => ({
                            ...
                            delivery_time: pricing.delivery_time ? pricing.delivery_time.split(" ")[0] : "",
        ...
        <div className="w-full min-h-screen">
                ...
                <div className="container mx-auto px-4 py-16">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-white">
                            <div className="inline-flex items-center gap-2 bg-orange-500 rounded-full px-4 py-2 text-sm font-medium mb-6">
                                Edit Gig
                            </div>
                            ...
                            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                                Turn your skills into income by creating professional gigs that attract the right clients
                            </p>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div className="flex flex-col items-center gap-2 p-4 bg-gray-800/50 rounded-xl backdrop-blur-sm">
                        ...
                        <div className="relative">
                            <div className="relative bg-gray-800/30 backdrop-blur-sm rounded-3xl p-8 border border-gray-600/30">
                                <div className="space-y-6">
                                    <div className="flex justify-center">
                                        <div className="relative">
                                            <div className="w-40 h-6 bg-gray-600 rounded-lg"></div>
                                            <div className="absolute -top-12 left-6 w-20 h-16 bg-gray-700 rounded-lg border-2 border-gray-600"></div>
                                            <div className="absolute -top-10 left-8 w-16 h-12 bg-orange-400/20 rounded flex items-center justify-center"></div>
                                            <div className="absolute -top-2 left-14 w-2 h-4 bg-gray-600"></div>
                                            <div className="absolute top-2 left-12 w-6 h-2 bg-gray-600 rounded"></div>
                                            <div className="absolute -top-20 left-16 w-8 h-8 bg-gray-500 rounded-full"></div>
                                            <div className="absolute -top-16 left-14 w-12 h-10 bg-gray-600 rounded-t-2xl"></div>
                                        </div>
                                    </div>
                                    <div className="flex justify-around items-center">
                                        <div className="w-14 h-14 bg-gray-700 rounded-xl flex items-center justify-center border border-gray-600"></div>
                                        <div className="w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center border border-gray-600"></div>
                                        <div className="w-16 h-16 bg-gray-700 rounded-2xl flex items-center justify-center border border-gray-600"></div>
                                    </div>
            ...
            {loading ? (
                ...
                <div className="mt-10 container mx-auto">
                    <GigsUpdateForm defaultValues={gigData} />
                </div>
            ) : (
