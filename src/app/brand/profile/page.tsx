...
import {Calendar, ExternalLink, Eye, Heart, MessageSquare, Settings, TrendingUp, Users} from 'lucide-react'
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <div
                                ...
                                <span
                                    className="text-white font-bold text-lg">{user?.nick_name?.charAt(0).toUpperCase() || "S"}</span>
                            </div>
                            <div>
                                <h1 className="text-xl font-semibold text-slate-900">Brand Profile</h1>
                                <p className="text-sm text-slate-600">{user?.nick_name}</p>
                            </div>
                        </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-semibold text-slate-900">
                                            {user?.social_profiles
                                                ? formatCompactNumber(user.social_profiles.reduce((sum, p) => sum + p.follower_count, 0))
                                                : "0"}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-semibold text-slate-900">
                                            {user?.social_profiles
                                                ? formatCompactNumber(Math.round(
