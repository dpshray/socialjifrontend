...
//     } = useForm<GigFormData>({
//         resolver: yupResolver(mode === "edit" ? gigsUpdateSchema : gigsSchema),
//         mode: "onBlur",
//         defaultValues: {
//             title: "",
//             category: "",
...
//     });
//
//     const {fields: pricingFields, append, remove, replace} = useFieldArray({control, name: "pricing"});
//
...
//             }
//         }
//     }, [defaultValues, mode, reset, replace]);
//
...
//                 const oldData = defaultValues;
//                 const changedData = data;
//                 // Optionally send oldData and changedData separately as needed
...
//                             onChangeAction={(value) => setValue("tags", value.map((v: any) => Number(v)), {shouldValidate: true})}
...
//                                 {loading || isSubmitting ? "Saving..." : mode === "edit" ? "Update Gig" : "Submit Gig"}
//                             </Button>
//                         </div>
//                     </div>
//                 </div>
